...
int rodarGrafo()
{
    ...
    // Printa a matriz em forma de lista
    std::cout << std::endl;
    std::cout << "Matriz de adjacencia em lista:" << std::endl;
    for (linha = 0; linha < n; linha++)
    {
        for (coluna = 0; coluna < n; coluna++)
            std::cout << matrizAdj[linha][coluna] << " -> ";
    ...
    // ------- Remover no -------
    int no;
    std::cout << "Digite o no que deseja remover" << std::endl;
    std::cin >> no;
    for (linha = 0; linha < n; linha++)
    {
        for (coluna = 0; coluna < n; coluna++)
